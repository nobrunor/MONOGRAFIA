...
in_dir <- file.path(ROOT, "build", "input", "PNAD_COVID")
...
data <- read_csv("PNAD_COVID_052020.csv",
                  col_types = cols_only(Ano = col_integer(),
                                        UF = col_integer(), UPA = col_character(), 
                                        V1008 = col_character(), V1022 = col_integer(), 
                                        A001 = col_character(), A003 = col_integer(), 
                                        A002 = col_integer(), A001A = col_integer(), A004 = col_character(),
                                        A005 = col_integer(), C001 = col_integer(), C007B = col_integer(),
                                        C01012 = col_double(), C008 = col_integer(), V1032 = col_double(),
                                        C007 = col_character(), C007B = col_character(), C014 = col_integer(),
                                        D0011 = col_character(), D0013 = col_integer(),
                                        D0021 = col_character(), D0023 = col_integer(),
                                        D0031 = col_character(), D0033 = col_integer(),
                                        D0041 = col_character(), D0043 = col_integer(),
                                        D0051 = col_character(), D0053 = col_integer(),
                                        D0061 = col_character(), D0063 = col_integer(),
                                        D0071 = col_character(), D0073 = col_integer()))
...
popuf <- data %>%
  select(UF, V1032, mes, Ano) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
  summarise(popuf = mean(aux))

###################
# renda media auxilio emergencial para informais #
###################

infauxiliorenda <- data %>%
  select(UF, V1032, mes, Ano, D0053, C007, C007B, C014, C001) %>%
  filter(C001 == 1 & ((C007 == 1 & C007B == 3) | (C007 == 4 & C007B == 3) | (C007 == 7 & C014 == 2) | (C007 == 8))) %>%
  mutate(aux = sum(V1032)) %>%
  group_by(mes) %>%
  summarise(infauxiliorenda = mean(aux))
...
pea <- data %>%
  select(UF, V1032, mes, Ano, VD4002) %>%
...
ocupfaixaetaria1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2009) %>%
  filter(VD4002 == "1" & (V2009 >= 18 & V2009 <= 29)) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
ocupfaixaetaria2 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2009) %>%
  filter(VD4002 == "1" & (V2009 >= 30 & V2009 <= 54)) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
ocupsalario1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V403311) %>%
...
ocupeduc1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, VD3004) %>%
...
ocupraca1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2010) %>%
  filter(VD4002 == "1" & (V2010 == "1" | V2010 == "3")) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
ocupraca2 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2010) %>%
  filter(VD4002 == "1" & (V2010 == "2" | V2010 == "4" | V2010 == "5")) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
ocupgenero1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2007) %>%
...
ocupurbana <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V1022) %>%
...
desalent <- data %>%
  select(UF, V1032, mes, Ano, VD4005) %>%
  filter(VD4005 == "1") %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
##############################
# subocupados de cada estado #
##############################

subocup <- data %>%
  select(UF, V1032, mes, Ano, VD4004, VD4004A) %>%
  filter(VD4004 == "1" | VD4004A == "1") %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
  summarise(subocupuf = mean(aux))

write.csv(subocup, paste0("C:/Users/Bruno/Desktop/MONOGRAFIA/build/tmp/subocupuf", yr, ".csv"))
...
ftpotencial <- data %>%
  select(UF, V1032, mes, Ano, VD4003) %>%
  filter(VD4003 == "1") %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
  summarise(ftpotencialuf = mean(aux))

write.csv(ftpotencial, paste0("C:/Users/Bruno/Desktop/MONOGRAFIA/build/tmp/ftpotencialuf", yr, ".csv"))
...
subutilizados <- data %>%
  select(UF, V1032, mes, Ano, VD4002, VD4004, VD4004A, VD4003) %>%
  filter((VD4002 == "2") | (VD4003 == "1") | (VD4004 == "1" | VD4004A == "1")) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
  summarise(subutilizadosuf = mean(aux))

write.csv(subutilizados, paste0("C:/Users/Bruno/Desktop/MONOGRAFIA/build/tmp/subutilizadosuf", yr, ".csv"))
...
#nemnem <- data %>%
  #select(UF, V1032, mes, Ano, V2009, V3002, V4074, V4074A, VD4001, VD4002) %>%
...
formal <- data %>%
  select(UF, V1032, mes, Ano, VD4009, VD4012) %>%
...
rendmedioformal <- data %>%
  select(UF, V1032, mes, Ano, VD4002, VD4009, VD4012, VD4019) %>%
  filter(VD4009 == "01" | VD4009 == "03" | VD4009 == "05" | VD4009 == "07" |
        (VD4009 == "08" & VD4012 == "1") | (VD4009 == "09" & VD4012 == "1")) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032),
         aux2 = sum(VD4019 * V1032),
         aux3 = aux2/aux) %>%
...
formaleduc1 <- data %>%
  select(UF, V1032, mes, Ano, VD4009, VD4012, VD3004) %>%
...
formalsalario1 <- data %>%
  select(UF, V1032, mes, Ano, VD4009, VD4012, V403311) %>%
...
informal <- data %>%
  select(UF, V1032, mes, Ano, VD4002, VD4009, VD4012) %>%
...
informalfaixaetaria1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2009, VD4009, VD4012) %>%
  filter(VD4002 == "1" & (V2009 >= 18 & V2009 <= 29) & (VD4009 == "02" | VD4009 == "04" | VD4009 == "06" | VD4009 == "10" |
           (VD4009 == "08" & VD4012 == "2") | (VD4009 == "09" & VD4012 == "2"))) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
informalfaixaetaria2 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2009, VD4009, VD4012) %>%
  filter(VD4002 == "1" & (V2009 >= 30 & V2009 <= 54) & (VD4009 == "02" | VD4009 == "04" | VD4009 == "06" | VD4009 == "10" |
           (VD4009 == "08" & VD4012 == "2") | (VD4009 == "09" & VD4012 == "2"))) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
informalfaixaetaria3 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2009, VD4009, VD4012) %>%
  filter(VD4002 == "1" & (V2009 >= 55) & (VD4009 == "02" | VD4009 == "04" | VD4009 == "06" | VD4009 == "10" |
           (VD4009 == "08" & VD4012 == "2") | (VD4009 == "09" & VD4012 == "2"))) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
informalsalario1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V403311, VD4009, VD4012) %>%
...
informaleduc1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, VD3004, VD4009, VD4012) %>%
...
informalraca1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2010, VD4009, VD4012) %>%
  filter(VD4002 == "1" & (V2010 == "1" | V2010 == "3") & (VD4009 == "02" | VD4009 == "04" | VD4009 == "06" | VD4009 == "10" |
           (VD4009 == "08" & VD4012 == "2") | (VD4009 == "09" & VD4012 == "2"))) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
informalraca2 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2010, VD4009, VD4012) %>%
  filter(VD4002 == "1" & (V2010 == "2" | V2010 == "4" | V2010 == "5") & (VD4009 == "02" | VD4009 == "04" | VD4009 == "06" | VD4009 == "10" |
           (VD4009 == "08" & VD4012 == "2") | (VD4009 == "09" & VD4012 == "2"))) %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
informalgenero1 <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V2007, VD4009, VD4012) %>%
...
informalurbana <- data %>%
  select(UF, V1032, mes, Ano, VD4002, V1022, VD4009, VD4012) %>%
...
informalprim <- data %>%
  select(UF, V1032, mes, Ano, VD4002, VD4009, VD4012, VD4010) %>%
...
prim <- data %>%
  select(UF, V1032, mes, Ano, VD4010) %>%
  filter(VD4010 == "01") %>%
  group_by(mes) %>%
  mutate(aux = sum(V1032)) %>%
...
x <- merge(pea, pia, by = c("mes"), all = TRUE)
x <- merge(x, desocup, by = c("mes"), all = TRUE)
x <- merge(x, cart, by = c("mes"), all = TRUE)
x <- merge(x, desalent, by = c("mes"), all = TRUE)
x <- merge(x, subocup, by = c("mes"), all = TRUE)
x <- merge(x, ftpotencial, by = c("mes"), all = TRUE)
x <- merge(x, subutilizados, by = c("mes"), all = TRUE)
x <- merge(x, ocup, by = c("mes"), all = TRUE)
x <- merge(x, ocupfaixaetaria1, by = c("mes"), all = TRUE)
x <- merge(x, ocupfaixaetaria2, by = c("mes"), all = TRUE)
x <- merge(x, ocupfaixaetaria3, by = c("mes"), all = TRUE)
x <- merge(x, ocupsalario1, by = c("mes"), all = TRUE)
x <- merge(x, ocupsalario2, by = c("mes"), all = TRUE)
x <- merge(x, ocupsalario3, by = c("mes"), all = TRUE)
x <- merge(x, ocupsalario4, by = c("mes"), all = TRUE)
x <- merge(x, ocupsalario5, by = c("mes"), all = TRUE)
x <- merge(x, ocupsalario6, by = c("mes"), all = TRUE)
x <- merge(x, ocupeduc1, by = c("mes"), all = TRUE)
x <- merge(x, ocupeduc2, by = c("mes"), all = TRUE)
x <- merge(x, ocupeduc3, by = c("mes"), all = TRUE)
x <- merge(x, ocupeduc4, by = c("mes"), all = TRUE)
x <- merge(x, ocupraca1, by = c("mes"), all = TRUE)
x <- merge(x, ocupraca2, by = c("mes"), all = TRUE)
x <- merge(x, ocupgenero1, by = c("mes"), all = TRUE)
x <- merge(x, ocupgenero2, by = c("mes"), all = TRUE)
x <- merge(x, ocupurbana, by = c("mes"), all = TRUE)
x <- merge(x, ocuprural, by = c("mes"), all = TRUE)
x <- merge(x, ocupnorte, by = c("mes"), all = TRUE)
x <- merge(x, ocupnordeste, by = c("mes"), all = TRUE)
x <- merge(x, ocupsudeste, by = c("mes"), all = TRUE)
x <- merge(x, ocupsul, by = c("mes"), all = TRUE)
x <- merge(x, ocupcentrooeste, by = c("mes"), all = TRUE)
x <- merge(x, formal, by = c("mes"), all = TRUE)
x <- merge(x, rendmedioformal, by = c("mes"), all = TRUE)
x <- merge(x, formaleduc1, by = c("mes"), all = TRUE)
x <- merge(x, formaleduc2, by = c("mes"), all = TRUE)
x <- merge(x, formaleduc3, by = c("mes"), all = TRUE)
x <- merge(x, formaleduc4, by = c("mes"), all = TRUE)
x <- merge(x, formalsalario1, by = c("mes"), all = TRUE)
x <- merge(x, formalsalario2, by = c("mes"), all = TRUE)
x <- merge(x, formalsalario3, by = c("mes"), all = TRUE)
x <- merge(x, formalsalario4, by = c("mes"), all = TRUE)
x <- merge(x, formalsalario5, by = c("mes"), all = TRUE)
x <- merge(x, formalsalario6, by = c("mes"), all = TRUE)
x <- merge(x, informal, by = c("mes"), all = TRUE)
x <- merge(x, informalfaixaetaria1, by = c("mes"), all = TRUE)
x <- merge(x, informalfaixaetaria2, by = c("mes"), all = TRUE)
x <- merge(x, informalfaixaetaria3, by = c("mes"), all = TRUE)
x <- merge(x, informalsalario1, by = c("mes"), all = TRUE)
x <- merge(x, informalsalario2, by = c("mes"), all = TRUE)
x <- merge(x, informalsalario3, by = c("mes"), all = TRUE)
x <- merge(x, informalsalario4, by = c("mes"), all = TRUE)
x <- merge(x, informalsalario5, by = c("mes"), all = TRUE)
x <- merge(x, informalsalario6, by = c("mes"), all = TRUE)
x <- merge(x, informaleduc1, by = c("mes"), all = TRUE)
x <- merge(x, informaleduc2, by = c("mes"), all = TRUE)
x <- merge(x, informaleduc3, by = c("mes"), all = TRUE)
x <- merge(x, informaleduc4, by = c("mes"), all = TRUE)
x <- merge(x, informalraca1, by = c("mes"), all = TRUE)
x <- merge(x, informalraca2, by = c("mes"), all = TRUE)
x <- merge(x, informalgenero1, by = c("mes"), all = TRUE)
x <- merge(x, informalgenero2, by = c("mes"), all = TRUE)
x <- merge(x, informalurbana, by = c("mes"), all = TRUE)
x <- merge(x, informalrural, by = c("mes"), all = TRUE)
x <- merge(x, informalnorte, by = c("mes"), all = TRUE)
x <- merge(x, informalnordeste, by = c("mes"), all = TRUE)
x <- merge(x, informalsudeste, by = c("mes"), all = TRUE)
x <- merge(x, informalsul, by = c("mes"), all = TRUE)
x <- merge(x, informalcentrooeste, by = c("mes"), all = TRUE)
x <- merge(x, informalnc, by = c("mes"), all = TRUE)
x <- merge(x, informalscart, by = c("mes"), all = TRUE)
x <- merge(x, informaltfa, by = c("mes"), all = TRUE)
x <- merge(x, informalprim, by = c("mes"), all = TRUE)
x <- merge(x, informalsec, by = c("mes"), all = TRUE)
x <- merge(x, informalterc, by = c("mes"), all = TRUE)
x <- merge(x, informalsecsemconstr, by = c("mes"), all = TRUE)
x <- merge(x, informaltercservicos, by = c("mes"), all = TRUE)
x <- merge(x, inss, by = c("mes"), all = TRUE)
x <- merge(x, popuf, by = c("mes"), all = TRUE)
x <- merge(x, prim, by = c("mes"), all = TRUE)
x <- merge(x, priv, by = c("mes"), all = TRUE)
x <- merge(x, publ, by = c("mes"), all = TRUE)
x <- merge(x, sec, by = c("mes"), all = TRUE)
x <- merge(x, terc, by = c("mes"), all = TRUE)
x <- merge(x, secsemconstr, by = c("mes"), all = TRUE)
x <- merge(x, tercservicos, by = c("mes"), all = TRUE)
x <- x %>% mutate(year = yr)
